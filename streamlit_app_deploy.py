"""
Deployment-ready Streamlit interface for the LLM-Powered Multi-Source Q&A System.

This app is optimized for Streamlit Cloud deployment and demonstrates the MLOps
concepts without requiring heavy ML models.
"""
...
# Page configuration
st.set_page_config(
    page_title="LLM-Powered Q&A System - MLOps Demo",
    page_icon="🤖",
    layout="wide",
...
MOCK_ANSWERS = {
    "What is machine learning?": {
        ...
        "sources": [
            {"title": "Machine Learning Basics", "source": "Wikipedia", "similarity": 0.95, "url": "https://en.wikipedia.org/wiki/Machine_learning"},
            {"title": "ML Fundamentals", "source": "Documentation", "similarity": 0.88, "url": "https://scikit-learn.org/stable/"},
            {"title": "AI and ML Guide", "source": "News", "similarity": 0.82, "url": "https://techcrunch.com/tag/artificial-intelligence/"}
        ],
        "confidence": 0.92,
        "processing_time": 1.8
    },
    "How does BERT work?": {
        ...
        "sources": [
            {"title": "BERT Architecture", "source": "Documentation", "similarity": 0.94, "url": "https://huggingface.co/bert-base-uncased"},
            {"title": "Transformer Models", "source": "Wikipedia", "similarity": 0.89, "url": "https://en.wikipedia.org/wiki/Transformer_(machine_learning)"},
            {"title": "NLP Advances", "source": "News", "similarity": 0.85, "url": "https://arxiv.org/abs/1810.04805"}
        ],
        "confidence": 0.89,
        "processing_time": 2.1
    },
    "What are the latest trends in AI?": {
        ...
        "sources": [
            {"title": "AI Trends 2024", "source": "News", "similarity": 0.96, "url": "https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai-in-2023"},
            {"title": "Latest in AI", "source": "News", "similarity": 0.91, "url": "https://venturebeat.com/category/ai/"},
            {"title": "AI Development", "source": "GitHub", "similarity": 0.87, "url": "https://github.com/topics/artificial-intelligence"}
        ],
        "confidence": 0.94,
        "processing_time": 1.6
    },
    "Explain the RAG architecture": {
        ...
        "sources": [
            {"title": "RAG Architecture", "source": "Documentation", "similarity": 0.97, "url": "https://arxiv.org/abs/2005.11401"},
            {"title": "Retrieval Systems", "source": "Wikipedia", "similarity": 0.90, "url": "https://en.wikipedia.org/wiki/Information_retrieval"},
            {"title": "AI Systems", "source": "GitHub", "similarity": 0.84, "url": "https://github.com/topics/rag"}
        ],
        "confidence": 0.91,
        "processing_time": 2.3
    },
    "What is FAISS and how is it used?": {
        ...
        "sources": [
            {"title": "FAISS Documentation", "source": "Documentation", "similarity": 0.93, "url": "https://github.com/facebookresearch/faiss"},
            {"title": "Vector Search", "source": "Wikipedia", "similarity": 0.88, "url": "https://en.wikipedia.org/wiki/Vector_search"},
            {"title": "ML Libraries", "source": "GitHub", "similarity": 0.86, "url": "https://github.com/topics/vector-search"}
        ],
        "confidence": 0.88,
        "processing_time": 1.9
    },
    "How do transformers work in NLP?": {
        ...
        "sources": [
            {"title": "Transformer Architecture", "source": "Documentation", "similarity": 0.95, "url": "https://arxiv.org/abs/1706.03762"},
            {"title": "NLP Models", "source": "Wikipedia", "similarity": 0.89, "url": "https://en.wikipedia.org/wiki/Transformer_(machine_learning)"},
            {"title": "AI Research", "source": "News", "similarity": 0.83, "url": "https://papers.nips.cc/paper/7181-attention-is-all-you-need"}
        ],
        "confidence": 0.90,
        "processing_time": 2.0
    }
...
def generate_mock_answer(question):
    ...
    return {
        ...
        "sources": [
            {"title": "Relevant Documentation", "source": "Documentation", "similarity": 0.85, "url": "https://example.com/doc"},
            {"title": "Related Article", "source": "Wikipedia", "similarity": 0.78, "url": "https://en.wikipedia.org/wiki/"},
            {"title": "Latest Information", "source": "News", "similarity": 0.72, "url": "https://techcrunch.com/"}
        ],
        "confidence": 0.82,
